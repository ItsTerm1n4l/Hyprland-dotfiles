...
primary=$(cat ~/.config/polybar/docky/colors.ini | awk 'NR==6' | awk -F"[#]" '{print $2}')

# SETTINGS {{{ ---

active_text_color=$primary
active_bg=
active_underline=$primary
...
forbidden_classes="Polybar Conky Lxpanel Gmrun Pcmanfm eww-bar"
...
raise_or_minimize() {
    ...
    paplay --volume=50000 ~/.config/themes/click-sound.wav
